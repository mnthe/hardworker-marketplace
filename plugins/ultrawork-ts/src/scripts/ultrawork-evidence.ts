...
import { getSessionDir, getSessionFile, readSession } from '../lib/session-utils';
...
function formatEvidenceEntry(entry: EvidenceEntry, index: number): string {
  const lines: string[] = [];
...
function showEvidenceLog(sessionId: string): void {
