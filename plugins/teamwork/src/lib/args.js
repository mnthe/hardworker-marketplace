...
/**
 * Common argument parsing utility for teamwork plugin scripts.
 ...
 * @property {string[]} [aliases] - All aliases for this argument (e.g., ['-p', '--proj'] for '--project')
 ...
 *
 * // With custom argv
 * const args = parseArgs(spec, ['node', 'script.js', '--project', 'abc']);
 */
