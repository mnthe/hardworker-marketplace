...
**Role-specific notes:**
- Prioritize tasks matching your specialization (review, refactoring, code quality)
- Apply code review best practices during implementation:
  - Be constructive (focus on improvements, not blame)
  - Be specific (point to exact issues with line numbers)
  - Prioritize critical issues first (security, correctness, then style)
  - Explain rationale for changes (why the improvement is better)
  - Verify behavior unchanged after refactoring (tests must still pass)
