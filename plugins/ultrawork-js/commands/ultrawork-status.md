...
allowed-tools: ["Bash(${CLAUDE_PLUGIN_ROOT}/dist/scripts/ultrawork-status.js:*)"]
---
...
```!
"${CLAUDE_PLUGIN_ROOT}/dist/scripts/ultrawork-status.js" --session {SESSION_ID}
```

Or list all sessions:

```!
"${CLAUDE_PLUGIN_ROOT}/dist/scripts/ultrawork-status.js" --all
```
